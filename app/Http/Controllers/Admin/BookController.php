...
class BookController extends Controller
{
    ...
    public function postAddBook(Request $request){
        ...
        //Neu truy van da ton tai record trong cac bang thi lay id do luu vao sach
        ...
        if($publishingCompany == null){
            ...
            $publishingCompany->name = $request->publishingCompany;
        ...
        for($i = 0; $i < count($request->category); $i++){
            ...
            if($category == null){
                ...
                $category->name = $request->category[$i];
                $category->save();
            }
