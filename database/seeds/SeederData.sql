...
insert into book (title, publisher_id, publishing_company_id, language_id, age_id, book_cover, publishing_year, book_cover_size, introduction, number_of_pages, inventory_number, price, sale)
values
